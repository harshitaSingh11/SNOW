    ...
    return (
        <div className="footer">
            <div className="footer_container">
                ...
                <p>
                    <b>Snow</b> is a project made with React JS 
                    For any suggestions or bug reports, visit 
                    <a href='https://github.com/harshitaSingh11/SNOW' target="_blank" rel="noopener noreferrer">
                    ...
                    giving a ⭐ for the Snow repository. <br /><br />
